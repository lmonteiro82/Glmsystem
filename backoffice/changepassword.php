	...
	<div class="limiter">
		<div class="container-login100 background">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="forgetpassword.php" method="post">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Este campo é obrigatório">
						<input class="input100" type="text" id="email1" name="email1" placeholder="Escreva o seu email">
