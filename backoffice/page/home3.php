...
<?php
    ...
    if (isset($_POST['but_jorge']))
    {
        ...
        {
            $qr = "update textos set texto=? where nome='jorge'";		
            $ordem = $ms->prepare($qr);				
    ...
    if (isset($_POST['but_marcio']))
    {
        ...
        {
            $qr = "update textos set texto=? where nome='marcio'";		
            $ordem = $ms->prepare($qr);				
    ...
    if (isset($_POST['but_leandro']))
    {
        ...
        {
            $qr = "update textos set texto=? where nome='leandro'";		
            $ordem = $ms->prepare($qr);				
    ...
    if (isset($_POST['but_lucia']))
    {
        ...
        {
            $qr = "update textos set texto=? where nome='lucia'";		
            $ordem = $ms->prepare($qr);				
